        ...
        <div>
            <header className='flex justify-between'>
                ...
                <div className='flex gap-2 border border-gray-300 rounded-full py-3 px-5 shadow-md shadow-gray-500'>
                    ...
                    <div className="border border-red-300"></div>
                    <div>Addguests</div>
                    <button className='bg-primary text-white pd-2 rounded-full '>
                ...
                <div className='flex gap-2 border border-gray-300 rounded-full py-3 px-5 shadow-md shadow-gray-500'>
                    ...
                    <Link to={user?'/account':'/login'} className='bg-gray-500 border border-gray-500 text-white rounded-full'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
